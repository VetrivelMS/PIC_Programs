...
MAIN:
    ...
    CALL CG_GEN				;CALL CG (CUSTOM GENERATOR) SUBROUTINE
...
NEXT2:
    MOVLW 0XC6					;DISPLAY CUSTOM CHARACTER 1 ON DD RAM LOCATION C6
    RCALL COMMAND   
    MOVLW 0X00					;DISPLAY 1ST CHARACTER
    RCALL DATAWRITE
    MOVLW 0X01					;DISPLAY 2ND CHARACTER
    RCALL DATAWRITE
    MOVLW 0X02					;DISPLAY THIRD CHARACTER
    RCALL DATAWRITE
    BRA $
...
CG_GEN:						;CG SUBROUTINE TO MAP OUR CUSTOM CHARACTER TO CGRAM LOCATION OF OUR LCD
    MOVLW 24
    MOVWF CG_COUNT_REG
    
    MOVLW 0X40					;FIRST CHARACTER CG RAM LOCATION
    RCALL COMMAND
...
C1: TBLRD*+					;REPEAT 24 TIMES TO STORE 3 CHARACTERS ON CG RAM LOCATION CONTINOUSLY
    MOVF TABLAT,W
    RCALL DATAWRITE
    DECF CG_COUNT_REG
    BNZ C1
...
MYCOMMAND: DB 0x02,0X28,0X01,0X06,0X0C,0X80,0	;DEFINE BYTES FOR THE COMMAND  (0X02 AND 0X28 COMMANDS IS A MUST FOR 4 BIT MODE OTHERWISE IT WON'T WORK)
...
CHAR1: DB 0x1F,0x14,0x1F,0x15,0x1D,0x01,0x1F,0x00  ;PIXEL MAPPING FOR TAMIL LETTER 1
CHAR2: DB 0x03,0x02,0x02,0x17,0x15,0x15,0x1F,0x00  ;PIXEL MAPPING FOR TAMIL LETTER 2
CHAR3: DB 0x04,0x00,0x17,0x15,0x1E,0x03,0x0E,0x00  ;PIXEL MAPPING FOR TAMIL LETTER 3
